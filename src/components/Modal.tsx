              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6" >
                  ...
                  <Dialog.Title as="h3" className="text-gray-900 text-2xl font-extrabold my-5">
                    ...
                    <button
                      type='button'
                      className='w-full rounded bg-gray-400 p-3 font-bold uppercase  text-white shadow   hover:bg-gray-500  '
                      onClick={closeModal}
                    >
                        Cerrar </button>
                    ...
                    <button
                      type='button'
                      className=' w-full rounded bg-orange-400  p-3 font-bold uppercase  text-white shadow hover:bg-orange-500  '
                      onClick = {()=>{hadleClickFavorite(selectedRecipe)}}
